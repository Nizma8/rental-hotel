...
const { ReviewController, getReviewController, filterReviewsController, getEachReviewController, EditReview } = require('../Controller/ReviewContoller')
...
router.get('/user/review/:id',jwtMiddleWare,getEachReviewController)
router.put('/reviews/edit/:id',EditReview)
